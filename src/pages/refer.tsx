  ...
  <Div style={{ spacing: 50, padding: '50px 0' }}>
    ...
    <Box title="SCREENING & SAFEGUARDING" toggle>
      <Txt style={styles.boxText}>
        ...
        age of 18 are not technically classified as ‘vulnerable adults’ many of
        them are nevertheless vulnerable. For this reason all befrienders on our
        database are screened and checked.
      </Txt>
      <Txt style={styles.boxText}>
        ...
        encounter, how the system works, best practice befriending, boundaries,
        signposting to specialist support services etc.
      </Txt>
      <Txt style={styles.boxText}>
      ...
      <Txt style={styles.boxText}>
        We do not take children (under 18) or people with substance abuse issues
        and advise against referring the highly vulnerable or those with mental
        health problems. If you feel it is necessary for the person you are
        referring to be matched with someone from our database who has a DBS,
        please state this in the any other information section at the end of the
        referral form.
      </Txt>
    </Box>
    <Box title="SCOPE OF SERVICES AND EXCLUSION OF LIABILITY" toggle>
      ...
      <Txt style={styles.boxText}>
        ...
        isolated asylum seekers, refugees or migrants in need of friendship, in
        contact with local, volunteer befrienders offering friendship. This is
        an altruistic, social arrangement and there is no payment or
        professional service provided.
      </Txt>
      <Txt style={styles.boxText}>
        Refugees referred to the service must understand that befrienders commit
        to meet their befriendee regularly (once every week or two weeks) over a
        period of 3 months. Befrienders offer time spent together to listen, to
        talk, to practice English, to explore the area and to make visits. They
        are there to make their friends feel welcome and valued as human beings.
      </Txt>
      <Txt style={styles.boxText}>
      ...
      <Txt style={styles.boxText}>
        ...
        given by befrienders or referrers. It will do what it can to ensure a
        successful match and arrange the first meeting but it cannot take
        ...
        month and 3 month intervals with both referrer and befriender.
      </Txt>
      <Txt style={{ ...styles.boxText, fontSize: 22, fontWeight: 'bold' }}>
