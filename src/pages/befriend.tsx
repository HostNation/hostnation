    ...
    <Div style={{ spacing: 50, paddingTop: 50 }}>
      ...
      <Box title="BEFRIENDER REGISTRATION FORM" color="yellow">
        ...
        <Txt style={styles.boxText}>
          ...
          info@hostnation.org.uk to express interest giving your name, age,
          gender and London postcode so we can get back in touch when we re-open
          our registration. The HostNation team.
        </Txt>
      </Box>
